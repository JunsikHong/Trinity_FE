    ...
    return (
        <div className="flex gap-3 p-3">
            <button
                ...
                className="flex h-11 flex-1 items-center justify-center gap-2 rounded-lg border border-border bg-icon hover:bg-icon-hover text-sm font-medium text-danger transition"
            >
                <Trash2 size={16} />
                삭제
            </button>
